...
RateMatrix (*cERAFS_init)(TTree *tree, TNode *des, double T, double at_dt, int event_site) = NULL;
//double (*cERAFS_update)(TTree *tree, TNode *des, double T, double at_dt, int event_site) = NULL;
