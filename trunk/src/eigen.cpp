      ...
      for (en = n-1; en >= 0; en--) {
         ...
         if ((q = vali[en]) < 0) {            /* complex vector */
            ...
            if (fabs(mat[pos(en,en-1,n)]) > fabs(mat[pos(en-1,en,n)])) {
               ...
               v = cdiv(c_compl(0.0,-mat[pos(en-1,en,n)]),
                    c_compl(mat[pos(en-1,en-1,n)]-p,q));
            ...
            for (i = en - 2; i >= 0; i--) {
               ...
               if (vali[i] < 0) {
                  ...
                  m = i;
                  if (vali[i] == 0) {
                     v = cdiv(c_compl(-ra,-sa),c_compl(w,q));
                     ...
                     v = cdiv(c_compl(x*r-z*ra+q*sa,x*s-z*sa-q*ra),v);
                     mat[pos(i,en-1,n)] = v.re;
                     mat[pos(i,en,n)] = v.im;
                     if (fabs(x) > fabs(z) + fabs(q)) {
                        ...
                        v = cdiv(c_compl(-r-y*mat[pos(i,en-1,n)],
                             -s-y*mat[pos(i,en,n)]),c_compl(z,q));
